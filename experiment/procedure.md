...
5.	Subtract Instrumental Broadening <br>
6.	Obtain the instrumental FWHM from a strain-free standard sample. <br>
7.	Subtract this instrumental contribution from β to isolate broadening due to lattice imperfections. <br>
8.	Calculate the dislocation density using the Scherrer’s formula: <br>
9.	β = Kλ/Dcosθ<sup>'</sup>	.............................(1)<br>
...
10.	Perform the above steps on different peaks to verify consistency. <br>
11.	Average the resulting dislocation density values for a representative result.<br>
...
10.	If counting discrete lines, use: ρ = N / (A × t).<br>
11.	If measuring total line length, equation is:<br>
    ρ = L/(A × t) 										(3)<br>
...
12.	Repeat for Multiple Regions<br>
13.	Collect images from different regions of the sample to ensure statistical validity.<br>
14. Average the dislocation densities from all micrographs for a final representative value.<br>
